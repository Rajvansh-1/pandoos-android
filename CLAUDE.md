# CLAUDE.md - Pandoos Project Guide for AI Agents
...
**Pandoos** is a FOSS (Free and Open Source Software) YouTube Music client for Android and Desktop, built with Compose Multiplatform.
...
### Basic Information
- **Package name**: `com.pandoos.music`
...
- **lyricsService/**: Lyrics fetching (LRCLIB, Pandoos Lyrics, BetterLyrics)
...
- **Features**:
  - Deep link support (`pandoos://` and `pandoos.org`)
...
**Location**: `core/media/media-jvm/src/main/java/com/pandoos/media_jvm/VlcPlayerAdapter.kt`
...
### Translation
- Use Crowdin: https://crowdin.com/project/pandoos
...
- **Pandoos Chart**: Chart playlists integrated into Library screen
...
- **Pandoos Lyrics voting**: Vote functionality for community lyrics

### New Features (post-1.0.4, dev branch)
- **Deep link support**: `pandoos://` and `pandoos.org` URL schemes
...
*This document helps AI Agents quickly understand the Pandoos project. Update regularly when there are major changes to architecture or structure.*
