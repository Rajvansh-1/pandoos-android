...
import com.pandoos.music.service.backup.AutoBackupScheduler
...
import org.pandoos.crashlytics.configCrashlytics
import java.lang.reflect.Field

class PandoosApplication :
    Application(),
    KoinComponent,
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            androidContext(this@PandoosApplication)
            loadAllModules()
